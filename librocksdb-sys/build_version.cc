...
static const std::string rocksdb_build_git_sha  = "3a00c5c139d5e7d3cac707ed198d51ec248b25ee";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:v9.9.3-1";
#define HAS_GIT_CHANGES 0
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2024-05-26 17:17:01";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2024-05-26 17:17:014";
#endif
